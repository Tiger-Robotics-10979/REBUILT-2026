...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public void shootWithPID() {
        shooterMotor.set(shooterPID.calculate(shooterMotor.getEncoder().getVelocity(), target)); //target is the targetted rpm that is generated by calculations from camera 
    } 
}
